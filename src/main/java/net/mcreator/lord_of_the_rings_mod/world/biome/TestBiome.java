...
package net.mcreator.lord_of_the_rings_mod.world.biome;
...
public class TestBiome extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:test")
	public static final CustomBiome biome = null;
	public TestBiome(LordOfTheRingsModModElements instance) {
		super(instance, 158);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			...
			addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, new CustomTreeFeature()
					.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.STRIPPED_OAK_LOG.getDefaultState()),
