...
public class MCreatorFoodPearYellow extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodpearyellow")
	public static final Item block = null;

	public MCreatorFoodPearYellow(Elementslord_of_the_rings_mod instance) {
		super(instance, 16);
	}
