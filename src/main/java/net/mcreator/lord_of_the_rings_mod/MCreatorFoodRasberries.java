...
public class MCreatorFoodRasberries extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodrasberries")
	public static final Item block = null;

	public MCreatorFoodRasberries(Elementslord_of_the_rings_mod instance) {
		super(instance, 25);
	}
