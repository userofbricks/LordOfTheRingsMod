...
public class MCreatorFoodBerryPie extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodberrypie")
	public static final Block block = null;

	public MCreatorFoodBerryPie(Elementslord_of_the_rings_mod instance) {
		super(instance, 14);
	}
