...
public class FoodDateBlock extends LordOfTheRingsModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:fooddate")
	public static final Block block = null;
	public FoodDateBlock(LordOfTheRingsModElements instance) {
		super(instance, 7);
	}
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new BasePlaceableFoodItem(block, new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food((
					new Food.Builder()).hunger(2).saturation(0.15f).build()), 0.0F, false).setRegistryName(block.getRegistryName()));
	}
