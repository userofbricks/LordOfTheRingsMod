...
public class LogOliveBlock extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:log_olive")
	public static final Block block = null;
	public LogOliveBlock(LordOfTheRingsModModElements instance) {
		super(instance, 159);
	}
