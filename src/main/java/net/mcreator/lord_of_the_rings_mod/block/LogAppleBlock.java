...
public class LogAppleBlock extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:log_apple")
	public static final Block block = null;
	public LogAppleBlock(LordOfTheRingsModModElements instance) {
		super(instance, 146);
	}
