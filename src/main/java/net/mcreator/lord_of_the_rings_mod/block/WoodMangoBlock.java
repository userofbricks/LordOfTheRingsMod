...
public class WoodMangoBlock extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:wood_mango")
	public static final Block block = null;
	public WoodMangoBlock(LordOfTheRingsModModElements instance) {
		super(instance, 152);
	}
