...
public class WoodCherryBlock extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:wood_cherry")
	public static final Block block = null;
	public WoodCherryBlock(LordOfTheRingsModModElements instance) {
		super(instance, 151);
	}
