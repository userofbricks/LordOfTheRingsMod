...
public class FoodBananaBlock extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodbanana")
	public static final Block block = null;
	public FoodBananaBlock(LordOfTheRingsModModElements instance) {
		super(instance, 2);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block,
				new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food((new Food.Builder()).hunger(4).saturation(0.3f).build()))
