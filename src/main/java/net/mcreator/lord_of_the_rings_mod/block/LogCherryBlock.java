...
public class LogCherryBlock extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:log_cherry")
	public static final Block block = null;
	public LogCherryBlock(LordOfTheRingsModModElements instance) {
		super(instance, 147);
	}
