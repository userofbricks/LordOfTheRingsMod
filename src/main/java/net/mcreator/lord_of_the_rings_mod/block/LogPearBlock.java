...
public class LogPearBlock extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:log_pear")
	public static final Block block = null;
	public LogPearBlock(LordOfTheRingsModModElements instance) {
		super(instance, 149);
	}
