...
public class WoodPearBlock extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:wood_pear")
	public static final Block block = null;
	public WoodPearBlock(LordOfTheRingsModModElements instance) {
		super(instance, 153);
	}
