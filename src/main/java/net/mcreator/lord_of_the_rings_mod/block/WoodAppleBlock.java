...
public class WoodAppleBlock extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:wood_apple")
	public static final Block block = null;
	public WoodAppleBlock(LordOfTheRingsModModElements instance) {
		super(instance, 150);
	}
