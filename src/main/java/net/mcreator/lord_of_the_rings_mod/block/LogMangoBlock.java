...
public class LogMangoBlock extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:log_mango")
	public static final Block block = null;
	public LogMangoBlock(LordOfTheRingsModModElements instance) {
		super(instance, 148);
	}
