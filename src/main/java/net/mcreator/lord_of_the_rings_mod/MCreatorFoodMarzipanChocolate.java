...
public class MCreatorFoodMarzipanChocolate extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodmarzipanchocolate")
	public static final Item block = null;

	public MCreatorFoodMarzipanChocolate(Elementslord_of_the_rings_mod instance) {
		super(instance, 73);
	}
