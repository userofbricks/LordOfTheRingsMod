...
public class MCreatorFoodLemonCake extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodlemoncake")
	public static final Block block = null;

	public MCreatorFoodLemonCake(Elementslord_of_the_rings_mod instance) {
		super(instance, 19);
	}
