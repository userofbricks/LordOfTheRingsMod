...
public class DrinkInGlass extends LordOfTheRingsModElements.ModElement {

	public DrinkInGlass(LordOfTheRingsModElements instance) {
	...
	public static final Block glass_cider = null;
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		RenderTypeLookup.setRenderLayer(glass_cider, RenderType.getTranslucent());
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event) {
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_water"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_milk"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_chocolate"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_mango_juice"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_blueberry_juice"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_blackberry_juice"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_rasberry_juice"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_cranberry_juice"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_elderberry_juice"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_orange_juice"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_lemonade"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_jungle_remedy"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_apple_juice"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_red_grape_juice"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_green_grape_juice"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_pomegranate_juice"));
		// alcohol
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_ale"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_mead"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_red_wine"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_perry"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_cherry_liqueur"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_rum"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_vodka"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_maple_beer"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_arak"));
		// miruvor
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_miruvor"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_miruvor1"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_miruvor2"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_miruvor3"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_miruvor4"));
		// orc draught
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_orc_draught"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_orc_draught1"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_orc_draught2"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_orc_draught3"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_orc_draught4"));
		// athelas brew
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_athelas_brew"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_athelas_brew1"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_athelas_brew2"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_athelas_brew3"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_athelas_brew4"));
		// dwarven tonic
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_dwarven_tonic"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_dwarven_tonic1"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_dwarven_tonic2"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_dwarven_tonic3"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_dwarven_tonic4"));
		// taurethrim cocoa
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_taurethrim_cocoa"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_taurethrim_cocoa1"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_taurethrim_cocoa2"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_taurethrim_cocoa3"));
		event.getRegistry().register(new CustomBlock().setRegistryName("glass_taurethrim_cocoa4"));
	}
	...
	public static void registerBlockItems(final RegistryEvent.Register<Item> event) {
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_milk, new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.milk),
						0, false, Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_milk"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_chocolate,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_mango_juice,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_blueberry_juice,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_blackberry_juice,
						new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.juice_berry), 0, false,
						Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_blackberry_juice"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_rasberry_juice,
						new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.juice_berry), 0, false,
						Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_rasberry_juice"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_cranberry_juice,
						new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.juice_berry), 0, false,
						Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_cranberry_juice"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_elderberry_juice,
						new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.juice_berry), 0, false,
						Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_elderberry_juice"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_orange_juice,
						new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.juice), 0, false,
						Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_orange_juice"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_lemonade,
						new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.juice), 0, false,
						Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_lemonade"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_jungle_remedy,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_apple_juice,
						new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.juice), 0, false,
						Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_apple_juice"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_red_grape_juice,
						new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.juice), 0, false,
						Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_red_grape_juice"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_green_grape_juice,
						new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.juice), 0, false,
						Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_green_grape_juice"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_pomegranate_juice,
						new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.juice), 0, false,
						Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_pomegranate_juice"));
		// alcohol
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_ale, new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.ale), 0,
						false, Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_ale"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_mead, new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.mead),
						0, false, Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_mead"));
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_red_wine,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_cherry_liqueur,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_rum, new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.rum), 0,
						false, Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_rum"));
		event.getRegistry().register(
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_maple_beer,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_arak, new Item.Properties().group(LOTRFoodAndDrinkTabItemGroup.tab).food(LOTRDrinks.arak),
						0, false, Item.getItemFromBlock(DrinkGlassBlock.block)).setRegistryName("glass_arak"));
		// miruvor
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_miruvor,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_miruvor1,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_miruvor2,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_miruvor3,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_miruvor4,
		...
		// orc draught
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_orc_draught,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_orc_draught1,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_orc_draught2,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_orc_draught3,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_orc_draught4,
		...
		// athelas brew
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_athelas_brew,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_athelas_brew1,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_athelas_brew2,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_athelas_brew3,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_athelas_brew4,
		...
		// dwarven tonic
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_dwarven_tonic,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_dwarven_tonic1,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_dwarven_tonic2,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_dwarven_tonic3,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_dwarven_tonic4,
		...
		// taurethrim cocoa
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_taurethrim_cocoa,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_taurethrim_cocoa1,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_taurethrim_cocoa2,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_taurethrim_cocoa3,
		...
		event.getRegistry()
				.register(new BasePlaceableDrinkItem(glass_taurethrim_cocoa4,
