...
public class FoodVenisonCookedItem extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodvenisoncooked")
	public static final Item block = null;
	public FoodVenisonCookedItem(LordOfTheRingsModModElements instance) {
		super(instance, 61);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("foodvenisoncooked");
		}
