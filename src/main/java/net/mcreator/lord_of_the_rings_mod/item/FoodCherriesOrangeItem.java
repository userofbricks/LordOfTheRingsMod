...
public class FoodCherriesOrangeItem extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodcherriesorange")
	public static final Item block = null;
	public FoodCherriesOrangeItem(LordOfTheRingsModModElements instance) {
		super(instance, 20);
	}
