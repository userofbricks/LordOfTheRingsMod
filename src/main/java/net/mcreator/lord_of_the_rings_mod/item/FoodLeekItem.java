...
public class FoodLeekItem extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodleek")
	public static final Item block = null;
	public FoodLeekItem(LordOfTheRingsModModElements instance) {
		super(instance, 48);
	}
