...
public class FoodChestnutRoastedItem extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodchestnutroasted")
	public static final Item block = null;
	public FoodChestnutRoastedItem(LordOfTheRingsModModElements instance) {
		super(instance, 39);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("foodchestnutroasted");
		}
