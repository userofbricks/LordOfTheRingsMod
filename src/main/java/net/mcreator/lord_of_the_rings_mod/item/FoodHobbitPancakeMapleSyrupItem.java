...
public class FoodHobbitPancakeMapleSyrupItem extends LordOfTheRingsModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodhobbitpancakemaplesyrup")
	public static final Item block = null;
	public FoodHobbitPancakeMapleSyrupItem(LordOfTheRingsModElements instance) {
		super(instance, 36);
	}
