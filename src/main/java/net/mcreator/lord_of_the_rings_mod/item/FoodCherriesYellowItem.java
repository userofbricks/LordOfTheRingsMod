...
public class FoodCherriesYellowItem extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodcherriesyellow")
	public static final Item block = null;
	public FoodCherriesYellowItem(LordOfTheRingsModModElements instance) {
		super(instance, 19);
	}
