...
import net.mcreator.lord_of_the_rings_mod.gui.GUIPouchLargeGui;
...
public class PouchLargeItem extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:pouch_large")
	public static final Item block = null;
	public PouchLargeItem(LordOfTheRingsModModElements instance) {
		super(instance, 145);
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Large Pouch");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GUIPouchLargeGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
