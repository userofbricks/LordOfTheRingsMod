...
public class FoodBlackBerriesItem extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodblackberries")
	public static final Item block = null;
	public FoodBlackBerriesItem(LordOfTheRingsModModElements instance) {
		super(instance, 24);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("foodblackberries");
		}
