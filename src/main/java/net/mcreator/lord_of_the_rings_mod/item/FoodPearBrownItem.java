...
public class FoodPearBrownItem extends LordOfTheRingsModModElements.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodpearbrown")
	public static final Item block = null;
	public FoodPearBrownItem(LordOfTheRingsModModElements instance) {
		super(instance, 17);
	}
