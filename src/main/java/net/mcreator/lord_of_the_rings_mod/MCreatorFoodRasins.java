...
public class MCreatorFoodRasins extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodrasins")
	public static final Item block = null;

	public MCreatorFoodRasins(Elementslord_of_the_rings_mod instance) {
		super(instance, 30);
	}
