...
public class LOTRMiscellaneousTabItemGroup extends LordOfTheRingsModElements.ModElement {
	public LOTRMiscellaneousTabItemGroup(LordOfTheRingsModElements instance) {
		super(instance, 81);
	}
