...
public class LOTRBlocksTabItemGroup extends LordOfTheRingsModModElements.ModElement {
	public LOTRBlocksTabItemGroup(LordOfTheRingsModModElements instance) {
		super(instance, 76);
	}
