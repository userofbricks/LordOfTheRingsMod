...
public class MCreatorFoodSalt extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodsalt")
	public static final Item block = null;

	public MCreatorFoodSalt(Elementslord_of_the_rings_mod instance) {
		super(instance, 75);
	}
