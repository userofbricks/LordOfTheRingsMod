...
public class MCreatorFoodCornCooked extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodcorncooked")
	public static final Item block = null;

	public MCreatorFoodCornCooked(Elementslord_of_the_rings_mod instance) {
		super(instance, 38);
	}
