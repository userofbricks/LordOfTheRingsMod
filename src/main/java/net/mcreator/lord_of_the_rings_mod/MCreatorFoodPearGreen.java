...
public class MCreatorFoodPearGreen extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodpeargreen")
	public static final Item block = null;

	public MCreatorFoodPearGreen(Elementslord_of_the_rings_mod instance) {
		super(instance, 15);
	}
