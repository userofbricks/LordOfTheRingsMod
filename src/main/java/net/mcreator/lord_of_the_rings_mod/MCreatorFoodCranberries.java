...
public class MCreatorFoodCranberries extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodcranberries")
	public static final Item block = null;

	public MCreatorFoodCranberries(Elementslord_of_the_rings_mod instance) {
		super(instance, 26);
	}
