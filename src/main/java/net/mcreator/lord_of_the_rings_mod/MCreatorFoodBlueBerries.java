...
public class MCreatorFoodBlueBerries extends Elementslord_of_the_rings_mod.ModElement {
	@ObjectHolder("lord_of_the_rings_mod:foodblueberries")
	public static final Item block = null;

	public MCreatorFoodBlueBerries(Elementslord_of_the_rings_mod instance) {
		super(instance, 23);
	}
